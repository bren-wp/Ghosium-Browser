...
The active product version is `0.0.3`. This is the only active version documented for the current Ghosium development line.
...
Previously published or candidate releases remain separate release classes and do not establish canonical 0.0.3 full-source production evidence.
